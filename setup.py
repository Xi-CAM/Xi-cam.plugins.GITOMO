...
setup(
    ...
    packages=['xicam.GITOMO', 'xicam.GITOMO.processing', 'xicam.GITOMO.widgets',
              'xicam.GITOMO.workflows', 'xicam.GITOMO.formats'],
    ...
    package_data={'xicam.GITOMO': ['*.yapsy-plugin'],
                  'xicam.GITOMO.formats': ['*.yapsy-plugin'],
                  'xicam.GITOMO.processing': ['*.yapsy-plugin'], },
